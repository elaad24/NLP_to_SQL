...
// role base - You are a virtual _ and you need to act like human __.
//gratitude - please do the following task
// todo : main task - _
// todo : context - provided the data as context
...
export const breakPromptToReasoningTasks = (
  ...
  *Expected Output:*  
  
  {
    ...
    `;
  const formatting = `return as JSON object as with the following format as the following interfaces :
